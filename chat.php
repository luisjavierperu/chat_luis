<?php session_start();
      if(empty($_SESSION['usuario']) && $_SESSION['cbo_horario']==0){  header('Location:index.php'); }
?>
<!DOCTYPE html>
<html lang="es">
<head>
                                        ...
                                        '<div class="media" style="overflow:visible;">'+
                                            '<div class="media-body" style="overflow:visible;">'+
                                                '<div class="row">'+  
                                                    ...
                                                    '</small>'+
                                                    '<br>'+
                                                    '<small class="text-muted">'+elem.chat_fecha+'</small>'+
                                                    '</div>'+
                                                '</div>'+
                                            '</div>'+
                                        '</div>'+
